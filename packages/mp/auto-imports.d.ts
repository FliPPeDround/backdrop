...
declare global {
  ...
  const patternTone: typeof import('./src/utils/tone').patternTone
  const patternTraits: typeof import('./src/utils/traits').patternTraits
  ...
  const uniStorage: typeof import('./src/utils/storage').uniStorage
  ...
  const useFavourites: typeof import('./src/composables/favourites').useFavourites
  ...
  const usePagedPatterns: typeof import('./src/composables/paged').usePagedPatterns
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly uniStorage: UnwrapRef<typeof import('./src/utils/storage')['uniStorage']>
